  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-10">
        {/* Header */}
        <div className="text-center space-y-4 max-w-2xl mx-auto" data-aos="fade-down">
          <span
        ...
        {allProducts.length === 0 ? (
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-16 text-center max-w-md mx-auto shadow-sm" data-aos="zoom-in">
                ...
                >
                  <div>
                    ...
                    <div className="p-6 space-y-3">
                      ...
                      <h3 className="text-xl font-bold leading-snug" style={{ color: "var(--theme-text, inherit)" }}>
                        {prod.title}
                      </h3>
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-slate-100 dark:border-slate-800/60 mt-4">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 px-4 py-2.5 font-bold transition-all shadow-sm"
                      style={{
