    ...
    lightboxIndex !== null ? (
      ...
      >
        ...
        <button
          type="button"
          onClick={closeLightbox}
          className="absolute right-6 top-6 z-[100000] rounded-full bg-white/10 p-3 text-white backdrop-blur-md transition-all hover:bg-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
        ...
        {images.length > 1 && (
          <>
            <button
              ...
              className="absolute left-6 top-1/2 -translate-y-1/2 z-[100000] rounded-full bg-white/10 p-3.5 text-white backdrop-blur-md transition-all hover:bg-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            ...
            <button
              ...
              className="absolute right-6 top-1/2 -translate-y-1/2 z-[100000] rounded-full bg-white/10 p-3.5 text-white backdrop-blur-md transition-all hover:bg-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            ...
            {images.map((img, idx) => (
              <Reveal key={idx} animation="fade-up" delay={idx * 80}>
                <button
                  ...
                  className="group card-hover-effect relative overflow-hidden rounded-3xl bg-slate-100 dark:bg-slate-800/80 shadow-sm hover:shadow-2xl transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--theme-primary,var(--primary))] focus-visible:ring-offset-2 border border-[var(--theme-card-border,rgba(226,232,240,0.8))] dark:border-slate-800 w-full"
